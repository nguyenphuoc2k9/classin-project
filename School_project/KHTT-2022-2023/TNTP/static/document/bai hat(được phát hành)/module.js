...
onAuthStateChanged(auth, (user) => {
  if (user) {
    ...
    var html = `<button onclick="window.location.replace('main/login_and_signup')" style="width: 80%; padding: 20px; font-size: larger; cursor: pointer; ;background-image: linear-gradient(to right, #f4b629, #f2ac22, #f0a11c, #ee9716, #eb8c12); border-radius: 10px; border: none; color: #fff;">Sign in</button>`
